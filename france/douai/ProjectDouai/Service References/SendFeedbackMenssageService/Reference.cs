...
// 
namespace ProjectDouai.SendFeedbackMenssageService {
    ...
    public interface FeedbackSoap {
        ...
        System.Threading.Tasks.Task<ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailResponse> SendFeedbackEmailAsync(ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequest request);
    }
    ...
    public partial class SendFeedbackEmailRequest {
        ...
        public ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequestBody Body;
        
        public SendFeedbackEmailRequest() {
        }
        
        public SendFeedbackEmailRequest(ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendFeedbackEmailResponse {
        ...
        public ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailResponseBody Body;
        
        public SendFeedbackEmailResponse() {
        }
        
        public SendFeedbackEmailResponse(ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface FeedbackSoapChannel : ProjectDouai.SendFeedbackMenssageService.FeedbackSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class FeedbackSoapClient : System.ServiceModel.ClientBase<ProjectDouai.SendFeedbackMenssageService.FeedbackSoap>, ProjectDouai.SendFeedbackMenssageService.FeedbackSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailResponse> ProjectDouai.SendFeedbackMenssageService.FeedbackSoap.SendFeedbackEmailAsync(ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequest request) {
            return base.Channel.SendFeedbackEmailAsync(request);
        }
        
        public System.Threading.Tasks.Task<ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailResponse> SendFeedbackEmailAsync(string xProject, string xMenssage, string xMail, string xSubject) {
            ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequest inValue = new ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequest();
            inValue.Body = new ProjectDouai.SendFeedbackMenssageService.SendFeedbackEmailRequestBody();
            inValue.Body.xProject = xProject;
            inValue.Body.xMenssage = xMenssage;
            inValue.Body.xMail = xMail;
            inValue.Body.xSubject = xSubject;
            return ((ProjectDouai.SendFeedbackMenssageService.FeedbackSoap)(this)).SendFeedbackEmailAsync(inValue);
        }
