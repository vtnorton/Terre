...
namespace ProjectNiceWIn8
{
    public sealed partial class MainPage : Page
    {
        ...
        private void txtSort_PointerMoved(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            txtSort.Background = White;
            txtSort.Background.Opacity = 0.4;
        }
        private void txtSort_PointerExited(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            txtSort.Background = new SolidColorBrush(Colors.Transparent);
        }
        private void txtClean_PointerMoved(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            txtClean.Background = White;
            txtClean.Background.Opacity = 0.4;
        }

        private void txtClean_PointerExited(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            txtClean.Background = new SolidColorBrush(Colors.Transparent);
        }

        private void txtSettings_PointerMoved(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            txtSettings.Background = White;
            txtSettings.Background.Opacity = 0.4;
        }

        private void txtSettings_PointerExited(object sender, Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
